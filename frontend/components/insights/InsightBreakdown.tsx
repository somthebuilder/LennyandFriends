    ...
    <div className="bg-white border border-charcoal-200 rounded-xl overflow-hidden animate-fade-in">
      ...
      <div className="flex items-center justify-between px-5 pt-4 md:hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill={isVoted ? 'url(#bulb-grad-mobile)' : 'none'} stroke={isVoted ? 'none' : 'currentColor'} strokeWidth={isVoted ? '0' : '1.5'} strokeLinecap="round" strokeLinejoin="round">
              {isVoted && <defs><linearGradient id="bulb-grad-mobile" x1="0" y1="0" x2="0.5" y2="1"><stop offset="0%" stopColor="#facc15"/><stop offset="50%" stopColor="#f59e0b"/><stop offset="100%" stopColor="#ea580c"/></linearGradient></defs>}
        ...
        <div className="hidden md:flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title={isVoted ? 'Marked as valuable' : 'Mark as valuable'}
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill={isVoted ? 'url(#bulb-grad-desktop)' : 'none'} stroke={isVoted ? 'none' : 'currentColor'} strokeWidth={isVoted ? '0' : '1.5'} strokeLinecap="round" strokeLinejoin="round">
                {isVoted && <defs><linearGradient id="bulb-grad-desktop" x1="0" y1="0" x2="0.5" y2="1"><stop offset="0%" stopColor="#facc15"/><stop offset="50%" stopColor="#f59e0b"/><stop offset="100%" stopColor="#ea580c"/></linearGradient></defs>}
                <path d="M12 2a7 7 0 0 0-7 7c0 2.38 1.19 4.47 3 5.74V17a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-2.26c1.81-1.27 3-3.36 3-5.74a7 7 0 0 0-7-7z" />
                <path d="M9 21a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-1H9v1z" />
              </svg>
              {insight.valuable_count > 0 && (
